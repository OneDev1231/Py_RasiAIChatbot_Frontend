            ...
            <div className="w-full flex flex-col gap-5 justify-start">
                ...
                <div className='flex flex-col gap-5 px-10 pb-5'>
                    <div className='flex flex-col gap-2 w-52'>
                        <label className='text-gray-800 dark:text-gray-200'>Change Name</label>
                        <Input type='text' value={name} onChange={handleUsernameChange}/>
                        <Button>Update Name</Button>
                    </div>

                    <div className='flex flex-col gap-2 w-52'>
                        <label className='text-gray-800 dark:text-gray-200'>Change Email</label>
                        <Input type='email' value={email} onChange={handleEmailChange}/>
                        <Button>Update Email</Button>
                    </div>

                    <div className='flex flex-col gap-2 w-52'>
                        <label className='text-gray-800 dark:text-gray-200'>Change Password</label>
